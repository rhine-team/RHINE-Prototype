...
func (l DSLeafContent) Equals(other DSLeafContent) (bool, error) {
	res := l.Start.Zone == other.Start.Zone && l.Start.Alv == other.Start.Alv && l.End.Zone == other.End.Zone && l.End.Alv == other.End.Alv
	res = res && l.Start.ZoneType == other.Start.ZoneType && l.End.ZoneType == other.End.ZoneType
	return res, nil
}
